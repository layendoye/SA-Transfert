...
// Returns the private 'App\Repository\UserCompteActuelRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserCompteActuelRepository.php';

return $this->privates['App\\Repository\\UserCompteActuelRepository'] = new \App\Repository\UserCompteActuelRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
