...
// Returns the private 'App\Repository\NomRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/NomRepository.php';

return $this->privates['App\\Repository\\NomRepository'] = new \App\Repository\NomRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
