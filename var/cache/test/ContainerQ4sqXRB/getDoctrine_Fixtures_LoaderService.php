...
$instance->addFixtures([0 => ['fixture' => ($this->privates['App\\DataFixtures\\AppFixtures'] ?? $this->load('getAppFixturesService.php')), 'groups' => []], 1 => ['fixture' => ($this->privates['App\\DataFixtures\\PrixFixtures'] ?? ($this->privates['App\\DataFixtures\\PrixFixtures'] = new \App\DataFixtures\PrixFixtures())), 'groups' => []]]);
