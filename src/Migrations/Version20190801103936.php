 ...
 */
final class Version20190801103936 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD compte_id INT DEFAULT NULL, ADD entreprise_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur DROP compte_id, DROP entreprise_id');
    }
}
