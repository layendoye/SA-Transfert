...
class Osms
{
     ...
     * @var string
     */
    protected $clientId = 'BOnx2MHPPQ9oaRjdJb0hKXARzdeVbWAQ';
    /**
     * Client Secret. Used to sign/crypt the requests.
     *
     * @var string
     */
    protected $clientSecret = 'PIC91mZv1IIHbCKk';
    /**
     * The Token will be used for all further API calls.
     *
     * @var string
     */
    protected $token = 'Basic Qk9ueDJNSFBQUTlvYVJqZEpiMGhLWEFSemRlVmJXQVE6UElDOTFtWnYxSUlIYkNLaw==';
    /**
